...
const About = () => {
  return (
    <div className="w-full h-[100vh] flex gap-5 bg-slate-200 overflow-hidden">
      <div
        className={`${raleway.className} antialiased w-[80%] flex flex-col justify-center items-center ml-40 md:ml-60 `}
      >
        <h1 className="w-[500px] text-black text-5xl text-center p-2">
          About Our Photo Studio
        </h1>
        <p className="w-[500px] text-black text-2xl text-center p-2">
        ...
        <ul className="w-[500px] text-black text-xl p-2">
          <li className="p-3">
          ...
          <li className="w-[500px] text-black text-xl p-2">
        ...
        <p className="w-[500px] text-black text-xl p-2">
